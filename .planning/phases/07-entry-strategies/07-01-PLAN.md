...
stack_ctxt slice for testing purposes.
  ...
  <verify>cargo test --package qwik-optimizer stack_ctxt 2>&1 && cargo test --package qwik-optimizer stack_ctxt -- --list 2>&1 | grep -c "test_stack_ctxt"</verify>
  <done>Unit tests verify stack_ctxt tracking works for components, JSX elements, and nested structures; at least 3 test_stack_ctxt tests exist</done>
</task>
