...
- [x] **TST-01**: All 164 snapshot tests ported from qwik-core (163 running, 1 OXC-only)
- [x] **TST-02**: Snapshot format matches insta requirements
- [x] **TST-03**: Test input files organized consistently

### Verification (Phase 13)

- [x] **VER-01**: All optimizer features in qwik-core implemented in OXC
  - 160/163 tests pass (98.2%), 3 ignored edge cases
- [x] **VER-02**: Test coverage matches or exceeds qwik-core
  - 164 spec parity tests + 239 unit tests = 403 total
- [x] **VER-03**: Edge cases from qwik-core covered
  - All issue regression tests ported (117, 150, 476, 964, 5008, 7216)
- [x] **VER-04**: API surface matches
  - Same TransformModulesOptions interface
